...
import { ArrowLeft, Save, Play, Tag, BookTemplate, History } from "lucide-react";
...
export default function WorkflowEditorPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      router.push("/msp/automation-hub/workflows");
    } catch (error) {
  ...
  return (
    <ReflectionContainer id="workflow-editor-page-container" label="Workflow Editor Page">
