  ...
  const templates = [
    {
      ...
      definition: {
        ...
        executeFn: `import { defineWorkflow } from '@shared/workflow/core/workflowDefinition';
 ...
 */
export const autoInvoiceWorkflow = defineWorkflow(
  {
    name: 'AutoInvoiceGeneration',
    description: 'Automatically generate invoices based on time entries',
    version: '1.0.0',
 ...
 */
export const ticketEscalationWorkflow = defineWorkflow(
  {
    name: 'TicketEscalation',
    description: 'Escalate support tickets based on SLAs',
    version: '1.0.0',
 ...
 */
export const assetInventoryWorkflow = defineWorkflow(
  {
    name: 'AssetInventoryNotifications',
    description: 'Alert when assets need maintenance',
    version: '1.0.0',
