            ...
            return knex('service_catalog').insert([
                {
                    ...
                    category_id: knex('service_categories').where({ tenant: 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', category_name: 'Network Services' }).select('category_id').first()
                },
                {
                    tenant: 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa',
                    ...
                    category_id: knex('service_categories').where({ tenant: 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', category_name: 'Security Services' }).select('category_id').first()
                },
                {
                    tenant: 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa',
                    ...
                    category_id: knex('service_categories').where({ tenant: 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', category_name: 'Cloud Services' }).select('category_id').first()
                },
                {
                    tenant: 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa',
                ...
                },
                {
                    ...
                    unit_of_measure: 'Hour',
                    tax_region: 'US-NY',
                    category_id: knex('service_categories').where({ tenant: 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', category_name: 'Support Services' }).select('category_id').first()
                },
                {
                    tenant: 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa',
