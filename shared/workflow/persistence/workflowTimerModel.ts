...
const WorkflowTimerModel = {
   ...
   */
  getByExecutionId: async (knex: Knex, tenant: string, executionId: string): Promise<IWorkflowTimer[]> => {
    try {
      if (!tenant) {
   ...
   */
  getActiveByExecutionId: async (knex: Knex, tenant: string, executionId: string): Promise<IWorkflowTimer[]> => {
    try {
      if (!tenant) {
        throw new Error('Tenant not found');
      }
   ...
   */
  getById: async (knex: Knex, tenant: string, timerId: string): Promise<IWorkflowTimer | null> => {
    try {
      if (!tenant) {
        throw new Error('Tenant not found');
      }
   ...
   */
  getByName: async (knex: Knex, tenant: string, executionId: string, timerName: string): Promise<IWorkflowTimer[]> => {
    try {
      if (!tenant) {
        throw new Error('Tenant not found');
      }
   ...
   */
  getDueTimers: async (knex: Knex, tenant: string): Promise<IWorkflowTimer[]> => {
    try {
      if (!tenant) {
        throw new Error('Tenant not found');
      }
   ...
   * Create a new timer
   */
  create: async (knex: Knex, tenant: string, timer: Omit<IWorkflowTimer, 'timer_id' | 'created_at'>): Promise<Pick<IWorkflowTimer, 'timer_id'>> => {
    try {
      if (!tenant) {
        throw new Error('Tenant not found');
      }
   ...
   * Update a timer
   */
  update: async (knex: Knex, tenant: string, timerId: string, timer: Partial<IWorkflowTimer>): Promise<void> => {
    try {
      if (!tenant) {
        throw new Error('Tenant not found');
      }
   ...
   */
  markAsFired: async (knex: Knex, tenant: string, timerId: string): Promise<void> => {
    try {
      if (!tenant) {
        throw new Error('Tenant not found');
      }
   ...
   */
  markAsCanceled: async (knex: Knex, tenant: string, timerId: string): Promise<void> => {
    try {
      if (!tenant) {
        throw new Error('Tenant not found');
      }
   ...
   */
  cancelAllForExecution: async (knex: Knex, tenant: string, executionId: string): Promise<void> => {
    try {
      if (!tenant) {
        throw new Error('Tenant not found');
      }
   ...
   */
  cancelAllForState: async (knex: Knex, tenant: string, executionId: string, stateName: string): Promise<void> => {
    try {
      if (!tenant) {
        throw new Error('Tenant not found');
      }
   ...
   * Delete a timer
   */
  delete: async (knex: Knex, tenant: string, timerId: string): Promise<void> => {
    try {
      if (!tenant) {
        throw new Error('Tenant not found');
      }
